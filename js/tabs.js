...
var indexGrid = 0;
 ...
 function getCollections(ans,target) {
	 ...
	 if (ans[0].error_code>0) {
		...
		createTd("tdTreeExpand", "trTreeExpand","");
		createP("pTree",'<a href="javascript: dCollection.openAll();">Expand all</a> | <a href="javascript: dCollection.closeAll();">Collapse all</a>',"tdTreeExpand");
		setStyle("tableCollectionTree","absolute","280px","","","190px");
		document.getElementById("tdTree").innerHTML=dCollection;	
